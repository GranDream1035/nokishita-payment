  ...
  return (
        <div style={outer}>
          ...
          <div style={productBox}>
              <p style={productName_}>{productName}</p>
            <p style={price}>¥{productPrice.toLocaleString()}</p>
    </div>
          <div style={features}>
...
const productName_ = { fontSize:'18px', fontWeight:'bold', color:'#333', margin:'0 0 8px 0' };
const price = { fontSize:'32px', fontWeight:'bold', color:'#06C755', margin:'0' };
